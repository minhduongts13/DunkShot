...
export default class GameOverLayer extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene & IChallengeScene & IGameScene) {
        ...
        this.titleText = scene.add.text(width/2, panelY + 30, `CHALLENGE ${PointManager.getCurrentLevel()} FAILED`, {
