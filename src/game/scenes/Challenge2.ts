...
import GameOverLayer from '../Layer/Challenge2/GameOverLayer';
import PauseLayer from '../Layer/PauseLayer';
import WinLayer from '../Layer/Challenge2/WinLayer';
import SettingsLayer from '../Layer/Settings';
import Settings from '../Manager/Settings';

export class Challenge2 extends Scene implements IGameScene, IHasDragZone
{
    ...
    public create (): void
    {
        ...
        this.baskets.push(new Basket(this, 200, 200, "empty"));
        this.baskets.push(new Basket(this, 60, 0, "empty"));
        this.baskets.push(new Basket(this, 300, -200, "empty"));
        this.baskets.push(new Basket(this, 60, -400, "empty"));
        this.baskets.push(new Basket(this, 180, -600, "empty"));
        this.baskets.push(new Basket(this, 300, -800, "empty"));
